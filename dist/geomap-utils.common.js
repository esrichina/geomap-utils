...
function _switchBaseMapByWebmapId() {
  _switchBaseMapByWebmapId = asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee2(view, webmapId) {
...
function _pointArr2Line() {
  _pointArr2Line = asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee3(pointArr) {
    var _ref5, _ref6, Polyline, ps;
    ...
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return jsapi.load(['esri/geometry/Polyline']);
          ...
          case 2:
            ...
            return _context3.abrupt("return", new Polyline({
              paths: [ps]
            }));
...
function () {
  function BaseLayerWrap(opts) {
    classCallCheck(this, BaseLayerWrap);
    ...
    if (lodash.isFunction(opts.before)) {
      this.beforeOnLoad = opts.before;
    }

    if (lodash.isFunction(opts.after)) {
      this.afterUnload = opts.after;
    }
  }

  createClass(BaseLayerWrap, [{
    key: "beforeOnLoad",
    value: function () {
      var _beforeOnLoad = asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "afterUnload",
    value: function () {
      var _afterUnload = asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "addToView",
    value: function () {
      var _addToView = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee3(view) {
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "removeFromView",
    value: function () {
      var _removeFromView = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee4(view) {
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
